  ...
  return (
    <main className="min-h-screen bg-[#0F171E] pt-20 page-transition">
      ...
      <div className="relative h-[75vh] min-h-[600px] overflow-hidden">
        ...
        <div className="relative z-10 flex items-center h-full px-8 md:px-16">
          <div className="max-w-3xl hero-content">
            ...
            <h1 className="text-6xl md:text-8xl font-black mb-6 text-white tracking-tight leading-none">LIVE TV</h1>

            <p className="text-xl text-gray-200 leading-relaxed mb-10 max-w-2xl">
              Watch live sports, news, and entertainment. Stream Thursday Night Football, breaking news, and exclusive
              live events - all included with your Prime membership.
            </p>
      ...
      <div className="py-12 space-y-12">
        <ContentRow title="Live Now" items={liveChannels} seeMoreLink="/live-tv/channels" />
        <ContentRow title="Upcoming Events" items={upcomingEvents} seeMoreLink="/live-tv/schedule" />

        {/* Live TV Schedule Section */}
        <div className="px-8 md:px-16">
          <h2 className="text-white text-2xl font-bold mb-6">Today's Schedule</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { time: "6:00 PM", title: "Evening News", channel: "Prime News", live: false },
              { time: "8:00 PM", title: "Thursday Night Football", channel: "Prime Sports", live: true },
              { time: "11:00 PM", title: "Late Night Entertainment", channel: "Prime Entertainment", live: false },
            ].map((program, index) => (
              <div
                key={index}
