...
const featuredTVShow = {
  ...
  backgroundImage: "/placeholder.svg?height=800&width=1400&text=THE+BOYS+Season+4",
  ...
  return (
    <main className="min-h-screen bg-[#0F171E] pt-20 page-transition">
      ...
      <div className="py-12 space-y-12">
        <ContentRow title="Prime Originals" items={featuredOriginals} seeMoreLink="/tv-shows/originals" />
        <ContentRow title="Popular TV Shows" items={topTVShows} seeMoreLink="/tv-shows/popular" />
        <ContentRow title="Crime & Thriller" items={crimeShows} seeMoreLink="/tv-shows/crime" />
        <ContentRow title="Sci-Fi & Fantasy" items={sciFiShows} seeMoreLink="/tv-shows/scifi" />
        <ContentRow title="Comedy Series" items={comedyShows} seeMoreLink="/tv-shows/comedy" />
      </div>
    </main>
  )
}
